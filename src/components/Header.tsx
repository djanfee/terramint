...
const Header = () => {
    ...
    return (
        <div className="flex items-center justify-between border border-neutrals-700 rounded-full box-content backdrop-blur-[1.5px] h-12 sm:h-16 px-3 sm:px-5 mt-6 hbase:mt-8 mb-2 sm:mx-6 bg-opacity-30 bg-black">
