...
const Home = () => {
    ...
    return (
        <div className="relative p-10 min-h-[calc(100vh-20px)] sm:min-h-[calc(100vh-40px)]">
            <Header></Header>
            <div className="grid grid-cols-12 mt-56 gap-4">
                ...
                <div className="col-start-6 col-span-3 flex items-center justify-center">
                ...
                <div className="col-start-9 col-span-5 flex items-center justify-center">
